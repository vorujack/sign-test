...
export class initialize1687534587363 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    const queries = [
      ...
      'CREATE TABLE "multi-sign-tx" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "bytes" text NOT NULL, "idx" integer NOT NULL, "type" text NOT NULL, "txId" integer, CONSTRAINT "FK_05595439c77fd3771bf77e84cf5" FOREIGN KEY ("txId") REFERENCES "wallet" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)',
      ...
      'CREATE TABLE "multi-commitment" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "bytes" text NOT NULL, "index" integer NOT NULL, "inputIndex" integer NOT NULL, "secret" text, "txId" integer, CONSTRAINT "FK_9d5228b8828161d8eb2c8286196" FOREIGN KEY ("txId") REFERENCES "wallet" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)',
      'CREATE TABLE "multi-signer" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "signer" text NOT NULL, "type" text NOT NULL, "txId" integer, CONSTRAINT "FK_fa7710bd6c52dc52a08ab8181fe" FOREIGN KEY ("txId") REFERENCES "wallet" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)',
